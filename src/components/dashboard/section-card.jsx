    ...
    <Card className={cn("min-w-0 overflow-hidden rounded-2xl", className)}>
      <CardHeader className="flex flex-col gap-2 pb-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 space-y-1">
          <CardTitle className="text-lg sm:text-[1.15rem]">{title}</CardTitle>
          {description ? <CardDescription className="max-w-3xl text-sm leading-5">{description}</CardDescription> : null}
        </div>
